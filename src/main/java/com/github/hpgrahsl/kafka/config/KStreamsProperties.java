...
public class KStreamsProperties {
    ...
    private String emojiTweetsTopic;
    ...
    public String getEmojiTweetsTopic() {
        return emojiTweetsTopic;
    }

    public void setEmojiTweetsTopic(String emojiTweetsTopic) {
        this.emojiTweetsTopic = emojiTweetsTopic;
    }
